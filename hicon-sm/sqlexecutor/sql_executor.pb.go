...
var file_hicon_sm_sql_executor_proto_rawDesc = string([]byte{
	...
	0x74, 0x6f, 0x32, 0xb1, 0x01, 0x0a, 0x0b, 0x53, 0x51, 0x4c, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74,
...
var file_hicon_sm_sql_executor_proto_goTypes = []any{
	...
	(*BaseResponse)(nil),        // 2: hicon.type.BaseResponse
}
var file_hicon_sm_sql_executor_proto_depIdxs = []int32{
	...
	2, // 2: SQLExecutor.UpsertConfiguration:output_type -> hicon.type.BaseResponse
	2, // 3: SQLExecutor.FindByPrimaryKeys:output_type -> hicon.type.BaseResponse
