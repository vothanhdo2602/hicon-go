...
var file_hicon_sm_sql_executor_proto_rawDesc = string([]byte{
	...
	0x74, 0x6f, 0x32, 0xed, 0x01, 0x0a, 0x0b, 0x53, 0x51, 0x4c, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74,
	...
	0x22, 0x00, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x73, 0x71, 0x6c, 0x65, 0x78, 0x65, 0x63, 0x75,
...
var file_hicon_sm_sql_executor_proto_goTypes = []any{
	...
	(*BaseResponse)(nil),        // 3: hicon.type.BaseResponse
}
var file_hicon_sm_sql_executor_proto_depIdxs = []int32{
	...
	3, // 3: SQLExecutor.UpsertConfiguration:output_type -> hicon.type.BaseResponse
	3, // 4: SQLExecutor.FindByPrimaryKeys:output_type -> hicon.type.BaseResponse
	3, // 5: SQLExecutor.FindOne:output_type -> hicon.type.BaseResponse
